...
## JSON 응답 형식
{
  "period": "monthly",
  "score": (1-100 사이 정수),
  "summary": "(이번 달 금전운 종합 요약, 4-5문장으로 풍성하게. 사주의 기운 흐름을 언급하며 구체적으로 서술)",
  "incomeLuck": "(수입운 해석, 3-4문장. 어떤 방향에서 수입이 들어오는지, 부수입 가능성, 주의할 점 등 구체적으로)",
  "expenseLuck": "(지출운 해석, 3-4문장. 어떤 종류의 지출이 늘어나는지, 특히 조심할 소비 패턴 등 구체적으로)",
  "savingsLuck": "(저축운 해석, 3-4문장. 저축하기 좋은 시기인지, 어떤 방식의 저축이 유리한지 구체적으로)",
  "investmentLuck": "(투자운 해석, 3-4문장. 운의 흐름상 적극적/보수적 어떤 자세가 좋은지 구체적으로)",
...
## JSON 응답 형식
{
  "period": "weekly",
  "score": (1-100 사이 정수),
  "summary": "(이번 주 금전운 요약, 3-4문장. 주간의 기운 흐름과 핵심 포인트를 구체적으로)",
  "spendingTip": "(이번 주 소비 관련 운세, 2-3문장. 어떤 소비를 조심해야 하는지, 좋은 소비 타이밍 등)",
  "savingTip": "(이번 주 저축/절약 관련 운세, 2-3문장. 구체적인 절약 방법이나 저축 타이밍)",
  "caution": "(이번 주 주의할 점, 2-3문장. 요일이나 상황을 구체적으로 언급)",
